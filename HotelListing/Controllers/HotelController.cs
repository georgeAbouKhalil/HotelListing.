    ...
    public class HotelController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateHotel(int id, [FromBody] UpdateHotelDTO hotelDTO)
        {
            ...
            try
            {
                ...
                _mapper.Map(hotelDTO, hotel); // what inside in hotelDTO put in hotel
                _unitOfWork.Hotels.Update(hotel); // we are update the hotel
                await _unitOfWork.Save(); // save the modify
